                ...
                {{-- <form class="p-8 space-y-8" method="POST" action="{{ url('/posts/update/' . $id ?? '1') }}" --}}
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title"
                            value="Tendencias en Decoración Minimalista 2024"
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="tags" class="block text-sm font-medium text-stone-700 mb-2">
                                Etiquetas
                            </label>
                            <input type="text" id="tags" name="tags"
                                value="minimalismo, decoración, hogar, tendencias"
                                class="w-full px-4 py-3 border border-stone-300 rounded-md focus:ring-2 focus:ring-amber-200 focus:border-amber-400"
                    ...
                    <div>
                        ...
                        <div
                            class="border-2 border-dashed border-stone-300 rounded-md p-6 text-center hover:border-amber-400 transition-colors">
                            <svg class="mx-auto h-12 w-12 text-stone-400" stroke="currentColor" fill="none"
                                viewBox="0 0 48 48">
                                <path
                            ...
                            <p class="mt-2 text-sm text-stone-600">
                                <span class="font-medium">Haz clic para subir</span> o arrastra aquí
                            </p>
                            <input type="file" id="poster" name="poster" accept="image/*" class="hidden">
                            <p class="text-xs text-stone-400 mt-1">PNG, JPG, GIF hasta 5MB</p>
                        </div>
                    </div>
