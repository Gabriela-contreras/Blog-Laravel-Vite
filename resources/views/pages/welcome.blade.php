...
@section('content')
    ...
    <section class="bg-[#cfbdaa] min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div class="absolute inset-0 bg-cover bg-center z-0"
            style="background-image: url('https://i.pinimg.com/736x/a5/8f/3e/a58f3ee1929b8a32772fe14ac8fd1746.jpg');">
        </div>
        ...
        <div class="absolute top-10 left-10 w-20 h-20 bg-white rounded-full animate-pulse z-20"></div>
        <div class="absolute top-32 right-20 w-16 h-16 bg-white rounded-full animate-bounce z-20"></div>
        <div class="absolute bottom-20 left-1/4 w-12 h-12 bg-white rounded-full animate-ping z-20"></div>
        ...
        <div class="relative z-30 text-center text-white px-4">
            ...
            <!-- Aquí va el div comentado si quieres reactivarlo -->
            {{-- 
    ...
    {{-- ejemplo de post --}}
<section id="post" class="flex flex-col mt-10 mb-6 items-center fade-slide-in">
